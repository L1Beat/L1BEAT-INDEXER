            ...
            schema: {
                ...
                querystring: {
                    ...
                    properties: {
                        timestamp: { 
                            type: 'number', 
                            description: 'Unix timestamp to get cumulative messages at. If not provided, returns latest.' 
                        }
                    },
                    additionalProperties: false
                },
                response: {
                    200: {
                        ...
                        properties: {
                            timestamp: { 
                                type: 'number', 
                                description: 'The timestamp for which the counts are valid' 
                            },
                            totalMessages: { 
                                type: 'number', 
                                description: 'Total number of ICM messages (incoming + outgoing) up to timestamp' 
                            },
                            totalOutgoing: { 
                                type: 'number', 
                                description: 'Total number of outgoing ICM messages up to timestamp' 
                            },
                            totalIncoming: { 
                                type: 'number', 
                                description: 'Total number of incoming ICM messages up to timestamp' 
                            }
                        },
